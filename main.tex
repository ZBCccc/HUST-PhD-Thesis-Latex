...
\input{body/chapter/commitment.tex}
\input{body/chapter/experiments.tex}
...
%%% 附录
\begin{appendix}
  \input{body/appendix/publications.tex}
  \input{body/appendix/abbrev.tex}
  \input{body/appendix/base-protocol.tex}
\end{appendix}
