...
本附录给出第~\ref{subsec:base-protocol} 节所述基础协议实例的四阶段算法伪码，即 Bag 等人\cite{bag2024tokenised}基于 ODXT\cite{patranabis2021forward} 的动态合取 SSE 构造在初始化、更新、令牌生成与搜索阶段的完整形式化定义。
